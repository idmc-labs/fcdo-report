...
export const youngGirlCaption = 'A young girl walks home from school in ldlib, Syria amongst the debris and ruins of the war. ©OCHA/AliHaj';
export const youngGirlSubCaption = 'Suleiman, November 2021';
...
export const primarySchoolCaption = 'Outside Darwish Primary School in Garowe, Somalia students read for one of their classes.';
export const primarySchoolSubCaption = '© UNICEF/UN0556449/Knowles-Coursin, November 2021';

export const childrenCaption = 'In a displacement site in the Ngote, Mahagi Territory of the Ituri Province in the Democratic Republic of Congo, a group of young boys looks ahead as class is being taught. ©Hugh Kinsella';
export const childrenSubCaption = 'Cunningham/NRC, April 2022.';
...
export const dataInternallyDisplacedDescription2 = 'These numbers are likely to be conservative given IDMC’s figures of the total number of IDPs in each country are likely to be underestimates. Evidence from various countries also shows that the proportion of children among displaced populations is often higher than among the general population. Despite the limitations, the estimates give a sense of the scale of the issue. The fact that children represent more than 30 per cent of all IDPs across the 13 countries makes it clear that their experiences and needs cannot be ignored.';

export const barChartCaption = 'Estimated number of school-aged IDPs in each of the 13 countries as of the end of 2021 by displacement trigger';
export const barChartTitle = 'Estimated number of school-aged IDPs across all 13 countries as of the end of 2021';
...
export const qualityEducationAuthor = 'Local youth representative, Beledweyne, Somalia';
...
export const pressReleaseLink = 'https://www.internal-displacement.org/sites/default/files/221117_IDMC_FCDO_PressRelease.pdf';
