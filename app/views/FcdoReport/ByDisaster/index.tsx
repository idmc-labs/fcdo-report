...
import chart3 from '#resources/img/chart3.svg';

const items = [
    {
        key: 'chart3-afghanistan',
...
function ByDisaster(props: Props) {
    const {
        className,
    } = props;
